Title: Morse
Subtitle: Morse code encoder/decoder in Ruby
Author: judofyr
HTML use syntax: true

Some of you might have noticed my [little attempt on refactoring][refmycode].
However, I quickly realized that it could be solved in a much simpler way:
...
[refmycode]: http://refactormycode.com/codes/513-morse-code-encoder-decoder#refactor_41227
